...
Source0  : https://cran.r-project.org/src/contrib/lintr_3.1.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711375275
...
/usr/lib64/R/library/lintr/tests/testthat/test-pipe-consistency-linter.R
...
/usr/lib64/R/library/lintr/tests/testthat/testthat-problems.rds
